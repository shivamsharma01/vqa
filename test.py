...
qst_vocab = load_str_list("vocab_questions.txt")
ans_vocab = load_str_list("vocab_answers.txt")
...
# python test.py --image_path 'C:\Users\priso\Downloads\VQA\Images\train2014\COCO_train2014_000000000081.jpg' --question 'what is written in the image?' --saved_model 'C:\Users\priso\Downloads\VQA\models\SAN-epoch-05.pt'
