...
from dataloader import VqaDataset, get_loader
...
#         hidden_size=args.hidden_size).to(device)
    ...
    if args.resume_epoch!=0:  
        model = torch.load(os.path.join(args.model_dir+'/',args.saved_model))
    ...
    for epoch in range(args.resume_epoch, args.num_epochs):
        ...
        for phase in ['train', 'valid']:
            ...
            for batch_idx, batch_sample in enumerate(data_loader[phase]):
                ...
                label = batch_sample['answer_label'].to(device).to(dtype=torch.long)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_name', type=str, default='SAN',
                        help='model name.') 
    ...
    parser.add_argument('--log_dir', type=str, default='C:/Users/priso/Downloads/VQA/logs',
                        help='directory for logs.')

    parser.add_argument('--model_dir', type=str, default='C:/Users/priso/Downloads/VQA/models',
    ...
    parser.add_argument('--resume_epoch', type=int, default = 15,
